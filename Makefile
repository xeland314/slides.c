...
coverage: clean_coverage src/core/lexer_c.c src/core/lexer_py.c src/core/lexer_go.c src/core/lexer_js.c src/core/lexer_ts.c src/core/lexer_tsx.c src/core/lexer_html.c src/core/lexer_css.c
...
clean:
	...
	$(RM) src/core/lexer_c.c src/core/lexer_py.c src/core/lexer_go.c src/core/lexer_js.c src/core/lexer_ts.c src/core/lexer_tsx.c src/core/lexer_html.c src/core/lexer_css.c
	$(RM) *.gcda *.gcno *.gcov
	$(RM) slider_coverage.dll libslider_coverage.so
	$(RM) coverage -rf
