...
class TestVisual(unittest.TestCase):
    ...
    def test_export_png(self):
        ...
        out_png = os.path.abspath(
            os.path.join(os.path.dirname(__file__), "test_output.png")
        )
        ...
        self.assertGreater(
            os.path.getsize(out_png), 1000
        )  # Un PNG mínimo debería pesar algo
    ...
    def test_export_all_themes(self):
        ...
        for theme in themes:
            with self.subTest(theme=theme):
                ...
                out_png = os.path.abspath(
                    os.path.join(os.path.dirname(__file__), f"test_{theme}.png")
                )
